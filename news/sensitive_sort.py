...
if __name__ == '__main__':
    ...
    logging.basicConfig(level=logging.INFO,
                ...
                filename='news.log',
                filemode='a')
    logging.info(' start sensitive_score_news:' + str(ts2HMS_1(time.time())) )
    main_yahoo(start_cal,end_cal,MONGOD_COLLECTION_1)
    logging.info(' end sensitive_score_news:' + str(ts2HMS_1(time.time())) )
    #main_twitter(start_cal,end_cal,MONGOD_COLLECTION_2)
    end_time = time.time()
    ca_time = end_time - start_time
    logging.info('total cal_time sensitive_score_news :'+ str(ca_time)  )
    print "sensitive_score_news cal_time:"+str(ca_time)
