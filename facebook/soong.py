...
MONGOD_PORT = 27017
MONGOD_DB = 'taiwan'
MONGOD_COLLECTION = 'fb_status_soong'
    ...
    for keyword in keywords:
        ...
        try:
            logging.basicConfig(level=logging.INFO,
                ...
                filename='facebook.log',
                filemode='a')
            logging.info(' start spider recent soong:' + str(ts2HMS_1(time.time())) )
            s.spider_website(keyword)
            logging.info(' end spider recent soong:' + str(ts2HMS_1(time.time())) )
