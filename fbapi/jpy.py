...
def main():
    req = urllib2.Request('https://graph.facebook.com/v2.5/46251501064_10153123962676065/comments?limit=1000&summary=1&access_token='+ACCESS_TOKEN)
...
def process_item(item):
    if collection.find({'m_id':item['m_id']}).count():
        ...
        for i in range(len(item['comments'])):
            if item['comments'][i] not in origin_comment:
